...
class Shamsi
{
    ...
    private String $tr_num_type = 'en';


    // /**
    //  * اعداد خروجی می‌توانند به صورت لاتین و یا فارسی باشند
    //  * به صورت پیشفرض لاتین است
    //  * @param string $name [ 'en' | 'fa' ]
    //  */
    // public function setTrNum(String $local){
    //     $this->tr_num_type = $local;
    //     return $this;
    // }
    ...
    /*	F	*/
    public function jstrftime($format, $timestamp = '', $none = '', $time_zone = 'Asia/Tehran')
    {
        ...
        return ($this->tr_num_type != 'en') ? $this->tr_num($out, 'fa', '.') : $out;
    }
    ...
    public function jgetdate($timestamp = '', $none = '', $timezone = 'Asia/Tehran', $tn = 'en')
    {
        ...
        $jdate = explode('_', $this->jdate('F_G_i_j_l_n_s_w_Y_z', $ts, '', $timezone));
        return array(
